...
validator = SchemaValidator(rootDir = "data/input")

validator.ValidateOptionsFiles(schemafile = os.path.join("../../../../schema", "phylo_storage.rng"), testDir = ".", depth = 1, extension = "phyml", xmlRootNode = "phylo_storage")

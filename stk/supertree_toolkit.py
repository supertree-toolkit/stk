...
import string
from . import stk_exceptions as excp
import traceback
from io import StringIO
...
def set_unique_names(XML):
    ...
    for k in unique_source_names.keys():

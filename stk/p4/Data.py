...
##        self.alignments = None
    ...
    def simpleBigXSquared(self):
        ...
        As in compoChiSquaredTest, but with no options, and hopefully
        faster.  It can't handle gaps or ambiguities.  It should be ok
        for simulations.  It returns a list of bigXSquared numbers,
